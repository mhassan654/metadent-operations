param(
     ...
     [Parameter()][string]$ResourceFolder = "../../../modules/clients-ne"
 )
...
$env= "prd"
$clientName = "stg-ne";
$clientShortName = "staging-ne";

$resourceGroupName = "$clientShortName-$env-rg"
$location = "NorthEurope"
$dnsZoneFrontend="$clientShortName.metadent.cloud"
$dnsZoneBackend="$clientShortName.api.metadent.cloud"
$appServicePlanName = "web-afr-ne-$env-01"
...
$appServicePlanResourceGroupName = "web-afr-ne-$env-rg"
...
$sqlDatabaseName = "$clientShortName$($env)01"
$sqlDatabaseNameEmails = "$($clientShortName)emails$($env)01"
$storageAccountName = "$($clientShortName)int$($env)01"
