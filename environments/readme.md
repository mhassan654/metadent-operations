...
- _shared_dev: shared resources like database servers, virtual networks, app service plans etc to be used for development purposes
- _shared_prd: shared resources like database servers, virtual networks, app service plans etc to be used for development purposes
- dev: development environment resources
- prd: production client folders
